    ...
    <section className="workspace" id="top">
      ...
      <div className="dashboard-grid">
        ...
        <section className="market-cockpit panel" id="market-section">
          ...
          <div className="market-method"><span>REAL FAILOVER</span><p>Primary requests have 8-second limits. Crypto fails over from Coinbase to Kraken; rates fail over from Treasury XML to FRED H.15. Provider failures are exposed above, and unsupported values remain blank.</p></div>
        </section>
