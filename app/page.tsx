...
export default function Home(){
  ...
  const pressureIndex=useMemo<PressureIndex|null>(()=>{
    ...
    const recentStories=stories.filter((story)=>clock-Date.parse(story.publishedAt)<=24*60*60*1000&&clock>=Date.parse(story.publishedAt));
